(function() {
	...
	app.controller('IntentsController', function() {
		...
		me.intents = [
			{ name: 'Add to Pocket', icon: 'http://getpocket.com/favicon.ico', tpl: 'http://getpocket.com/edit?url={url}' },
			{ name: 'Share by email', icon: 'http://www.durbin.senate.gov/public/_skins/durbin/images//share/email_32.png', tpl: 'mailto:?subject={title}&body={url}' },
			{ name: 'Buffer', icon: 'https://bufferapp.com/favicon.ico', tpl: 'http://bufferapp.com/add?url={url}&text={title}' },
			{ name: 'Share on Facebook', icon: 'http://www.ripleys.com/wp-content/uploads/2014/04/facebook.png', tpl: 'http://www.facebook.com/sharer.php?u={url}' },
			{ name: 'Share on Twitter', icon: 'https://abs.twimg.com/favicons/favicon.ico', tpl: 'https://twitter.com/intent/tweet?url={url}&text={title}' },
			{ name: 'Share on GPlus', icon: 'https://www.gstatic.com/images/icons/gplus-32.png', tpl: 'https://plus.google.com/share?url={url}' },
